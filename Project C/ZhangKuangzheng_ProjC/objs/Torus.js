function defTorus() {
    ...
    let Vertices = convertStripe(Torus_Vertices);
    updateInfo('Torus', 'Body', Vertices);
    defNormals(Level1 = 'Torus', Level2 = 'Body', Info.Torus.Body.vertices);
}
...
function drawTorus(interval, modelMatrix, u_ModelMatrix, colorMatrix, u_ColorMatrix) {
    ...
    gl.drawArrays(gl.TRIANGLES, Info.Torus.Body.position, Info.Torus.Body.n);
}